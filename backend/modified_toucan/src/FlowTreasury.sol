...
/**
 * @title FlowTreasury
 * @notice Treasury contract managed by Cadence-Owned Accounts
 * @dev This contract can execute arbitrary calls and receive ETH, ERC721, and ERC1155 tokens
 */
contract FlowTreasury is Ownable, ERC721Holder, ERC1155Holder {
    ...
    /// @notice Sets the owner to the Cadence-Owned Account that deploys this contract
     ...
     * @dev Only Cadence-Owned Account (owner) can call this function. Arrays must have equal length.
